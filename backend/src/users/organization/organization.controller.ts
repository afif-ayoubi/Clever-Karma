...
export class OrganizationController {
    ...
    @Patch(':id')
    async updateOrganization(@Param('id') id: string, @Body() organizationDto: OrganizationDto): Promise<OrganizationDetail> {
        return this.organizationService.updateOrganization(id, organizationDto);
    }
}